                ...
                function springTrack() {
                    ...
                    this.st_tracking_parameters = {};
                    
                    this.user_logged_in = false;
                    this.is_logout = ( document.location.search.indexOf("msg=logout") > -1 );
                    this.do_not_track = ( document.location.search.indexOf("tracking=off") > -1 );
                    this.is_preview = ( document.location.search.indexOf("preview=") > -1 );
                    this.is_cg = true;
                    
                    this.tracking_parameters = {};
                    this.tracking_server_host = "lg2proc-stats.springyaws.com";
                    this.tracking_script = "log.php";
                    this.page_params = document.location.search;
                    this.opt_use_page_params = true;
                    this.imgs = new Array();
                    this.img_idx = 0;
                    this.track_delay = 600;
                    this.sessionCookieTimeout = 30; // 30 minutes
                    this.referrerCookieTimeout = 60 * 24 * 30 * 6; // 6-months
                    this.cookie_session = {};
                    this.cookie_referrer = {};
                ...
                springTrack.prototype.createCookie = function(name,value,expires_min) {
                    if (expires_min) {
                        var date = new Date();
                        // 24*60*
                ...
                springTrack.prototype.readCookie = function(name) {
                    var nameEQ = name + "=";
                ...
                springTrack.prototype.updateCookieExpiration = function(name, expires_min) {
                    // Create a new cookie with the same value and a new expiration time.
                    this.createCookie(name,this.readCookie(name),expires_min);
                }
                springTrack.prototype.eraseCookie = function(name) {
                    this.createCookie(name,"",-1);
                }
                springTrack.prototype.init = function(config_obj) {
                ...
                springTrack.prototype.setSpringTrackData = function(config_obj) {
                ...
                springTrack.prototype.setParameter = function(name, value, label) {
                    // Use this to set tracking parameters to send to the tracking server.
                    
                }
                springTrack.prototype.trackIt = function(config) {
                    ...
                    if ( !this.user_logged_in && !this.is_preview && !this.is_logout && !this.do_not_track ) {
                        ...
                        switch (config._st_log_type) {
                            case "1":
                                ...
                                break;
                            case "2":
                                server_path = "guides.library.berklee.edu/libguides";
                                break;
                            default:
                                server_path = this.tracking_server_host;
                                break;
                        }
                        var track_src = "http://" + server_path + "/" + this.tracking_script + this.generateQSData(config);
                ...
                springTrack.prototype.generateQSData = function(config) {
                    // This method is responsible for generating the tracking data request to the tracking server.
                ...
                //-------------------------------------------------------
                springTrack.prototype.generateCookieQSData = function() {
                    var qs_arr = new Array();
                ...
                springTrack.prototype.propExists = function(obj, prop) {
                    return ( typeof(obj[prop]) != "undefined" ? true : false );
                }
                springTrack.prototype.getResourceType = function(elt, config) {
                ...
                springTrack.prototype.track = function(elt, config) {
                    //debugger;
                ...
                springTrack.prototype.gaLinkTracking = function(config_obj) {
                    try {
                ...
                springTrack.prototype.trackLink = function(config) {
                    //this.gaLinkTracking();
                ...
                springTrack.prototype.trackPage = function(config) {				
                    //this.tracking_fields.resource_type.val = this.getResourceType(null, config);
                    this.trackIt(config);
                }
                springTrack.prototype.trackEr = function(config) {				
                    this.trackIt(config);
                }
                springTrack.prototype.trackDiscussion = function(config) {                    
                    this.trackIt(config);
                }
				springTrack.prototype.trackPageRedirect = function(config) {				
                    //this.tracking_fields.resource_type.val = this.getResourceType(null, config);
                ...
                springTrack.prototype.trackForm = function(form_obj, config) {
                ...
                springTrack.prototype.trackSearch = function(config) {
                    //this.tracking_fields.resource_type.val = this.getResourceType(null, config);
